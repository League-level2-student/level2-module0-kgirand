...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String input = JOptionPane.showInputDialog("Type any positive whole number");
		int inti = Integer.parseInt(input); 
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		buttons = new JButton[inti];
		...
		hiddenButton = randy.nextInt(inti);
